...
@connect(({ machine_areaauth, loading }) => ({
  ...machine_areaauth,
  confirmLoading: loading.effects['machine_areaauth/addArea']
}))
@Form.create({
...
class AddModal extends React.Component {
  ...
  handleOk = () => {
    ...
    validateFields((errors, values) => {
      if (!errors) {
        dispatch(Action('machine_areaauth/addArea', {
          ...values
