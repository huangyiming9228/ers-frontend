...
class QueryForm extends React.Component {
  ...
  componentDidMount() {
    this.props.dispatch(Action('machine_checklist/getAreaList'));
    this.props.dispatch(Action('machine_checklist/submit'));
  }
  ...
  handleAreaChange = value => {
    ...
    dispatch(Action('machine_checklist/getRoomList', { value })).then(() => {
      setFieldsValue({
        room: null,
      });
    });
  ...
  handleSubmit = e => {
    ...
    validateFields(errors => {
      if (!errors) {
        dispatch(Action('machine_checklist/submit'));
      }
    });
  }
